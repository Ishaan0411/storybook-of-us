document.addEventListener('DOMContentLoaded', () => {
  let currentPage = 0;
  const pages = [
    { content: 'assets/page1.jpg', message: [
    ...
    { content: 'assets/page2.jpg', message: [
    ...
    { content: 'assets/page3.jpg', message: [
    ...
    { content: 'assets/page4.jpg', message: [
  ...
  function displayPage() {
    ...
    const pageContent = `<img src="${page.content}" alt="Page image">`;
